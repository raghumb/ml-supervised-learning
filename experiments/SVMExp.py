...
from learners.LinearSVMLearner import LinearSVMLearner
import numpy as np
...
class SVMExp:
    ...
    def model_complexity_exp_linear1(self):
        ...
        self.expHelper = ExperimentHelper(self.splitter, self.learner, 'linear-2', 'LinearKernel')
    ...
    def model_complexity_exp_linear2(self):
        ...
        self.expHelper = ExperimentHelper(self.splitter, self.learner, 'linear-3', 'LinearKernel')
    ...
    def learning_curve_iter2_wine_linear(self): 
        ...
        self.expHelper = ExperimentHelper(self.splitter, self.learner, 'Linear Kernel')
        self.expHelper.learning_curve_exp()  

    def learning_curve_iter2_bank_linear(self): 
        print("linear")
        self.learner = LinearSVMLearner(fit_intercept = True, C = 0.01, intercept_scaling =6)
        self.expHelper = ExperimentHelper(self.splitter, self.learner, 'Linear Kernel')
        self.expHelper.learning_curve_exp()                 
